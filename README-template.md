...
the [Weather app challenge on Frontend Mentor](https://www.frontendmentor.io/challenges/weather-app-K1FhddVm49).
...
- See additional weather metrics like "feels like" temperature, humidity percentage, wind speed, and precipitation
  amounts
...
- Switch between specific temperature units (Celsius and Fahrenheit) and measurement units for wind speed (km/h and mph)
  and precipitation (millimeters) via the units dropdown
...
- Solution URL: [Project Solution Repo URL](https://github.com/LorryAfriyie/weather-app)
